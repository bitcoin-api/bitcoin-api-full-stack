...
```
to view the fee data worker logs in realtime. You can also subscribe to their web services and see your logs in your browser, in realtime, using the [pm2 webapp](https://app.pm2.io/).
