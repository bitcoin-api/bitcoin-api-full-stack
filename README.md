...
MongoDB is used for caching on your Bitcoin-Api Bitcoin node server. It prevents unnecessary non local server database writes to the main cloud database when updating addresses and balances.
