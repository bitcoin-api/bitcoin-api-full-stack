...
* `bankStatusQueueId` - stream - the NodeJS services periodically send requests to this queue to indicate that they're active, this is used by the API to determine if it's active or not - max length 2000
