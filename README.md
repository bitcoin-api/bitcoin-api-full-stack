...
The Bitcoin node and the API are considered the "backend" of the "stack" in the "full stack" concept. The backend code and the data associated with the code is on your computer servers and is not publicly accessible by users.
