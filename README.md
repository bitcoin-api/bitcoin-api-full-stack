...
After creating your own Bitcoin-Api instance and generating Bitcoin revenue, [Xapo](https://xapo.com) is the perfect place to store larger amounts of Bitcoin from your instance's Bitcoin node(s).

Xapo is an established digital banking company which is used for ultra-secure and discrete Bitcoin and fiat money storage, exchanging, and management. In addition to their robust technical base, Xapo has a very high level of international legal compliance, which is not to be taken for granted in the crypto industry. Xapo also promotes, contributes to, and develops [Bitcoin](https://www.forbes.com/sites/rorymurray/2020/06/18/bitcoin-grant-marks-another-step-forward-but-questions-on-industry-funding-remain/#7f5ac7627091) and the [crypto space](https://www.facebook.com/xapoapp/posts/welcome-to-libra-today-we-are-announcing-a-new-global-currency-built-on-blockcha/2425315364198784/). Check out their [nuclear blast and EMP proof underground money vault](https://qz.com/1103310/photos-the-secret-swiss-mountain-bunker-where-millionaires-stash-their-bitcoins/)!

#### Why are Amazon Web Services (AWS) used as the foundation for Bitcoin-Api's tech?

The Bitcoin-Api system's foundation uses several cloud services provided by [Amazon Web Services (AWS)](https://aws.amazon.com). AWS is used because the services they offer provide a good tech foundation for the following reasons:
1. AWS has very high quality and competitively priced cloud services
2. In using AWS, you have full ownership of your data 💯🤠
